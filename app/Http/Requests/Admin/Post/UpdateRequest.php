...
class UpdateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'title.string' => 'Данние должны соотвествовать строчному типу',
            'content.required' => 'Это поле необходимо заполнить',
            'content.string' => 'Данние должны соотвествовать строчному типу',
            ...
            'tag_ids.array' => 'Необзодимо отправить массив данных',
        ];
    }
}

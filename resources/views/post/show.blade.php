...
@section('content')
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">• {{ $data->translatedFormat('F') }} {{ $data->day }}, {{ $data->year }}• {{ $data->format('H:i') }} • {{ $post->comments->count() }} Comments</p>
